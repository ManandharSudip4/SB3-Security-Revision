...
public class HomeControllerTest {
  ...
  void anyoneCanViewPublicEndpoint() throws Exception {
    api
      ...
      .andExpect(content().string(containsStringIgnoringCase("Mun")));
  }
  ...
  void loggedIn_shouldSeeSecuredEndpoint() throws Exception {
    api
      .perform(get("/secured"))
      .andExpect(status().isOk())
      .andExpect(content().string(containsStringIgnoringCase("Successful")));
  }
  ...
  void admin_shouldSeeAdminEndpoint() throws Exception {
    api
      .perform(get("/admin"))
      .andExpect(status().isOk())
      .andExpect(content().string(containsStringIgnoringCase("Admino")));
  }
}
